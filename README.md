...
Also, have included this test runner on shellscript that simulates some scenarios along with edge cases and race condition checks. The runner is @ [billing-backend/scripts/test-runner.sh](billing-backend/scripts/test-runner.sh), kindly do check out.
---
